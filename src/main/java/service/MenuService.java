...
public class MenuService {
	...
	private void option3() {
		carService
				.getCarsWithSpecifiedBodyTypeInThePriceRange(userDataService.getCarBodyType(), userDataService.getBigDecimal("Enter min price"), userDataService.getBigDecimal("Enter max price"))
	...
	private void option8() {
		carService
				.getCarsWithSpecifiedComponent(userDataService.getComponents())
